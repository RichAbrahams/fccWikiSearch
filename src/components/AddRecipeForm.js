...
let AddRecipeForm = (props) => {
  const style = {
    paddingLeft: 0,
    paddingTop: '2em',
  };
  const { handleSubmit, addRecipe } = props;
  return (
    <Form onSubmit={handleSubmit}>
      ...
      <CardActions>
        ...
        <RaisedButton label="Cancel" secondary onClick={() => addRecipe(null)} />
      </CardActions>
    </Form>
  );
};
...
AddRecipeForm = reduxForm({ // eslint-disable-line no-class-assign
  form: 'addRecipe',
})(AddRecipeForm);
